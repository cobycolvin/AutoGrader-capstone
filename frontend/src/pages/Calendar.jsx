        ...
        >
          <Stack spacing={0.35}>
            ...
            <Typography variant="body2" color="text.secondary">
              Plan across assignments and personal events in one place.
            </Typography>
          </Stack>
            ...
            <Stack spacing={1.5}>
              ...
              >
                ...
                <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
                  <Chip
                    ...
                    color="primary"
                    variant="outlined"
                    label={`${monthSummary.deadlineCount} assignment due${monthSummary.deadlineCount === 1 ? '' : 's'}`}
                  />
                  <Chip
                    size="small"
                    color="secondary"
                    variant="outlined"
                    label={`${monthSummary.eventCount} event${monthSummary.eventCount === 1 ? '' : 's'}`}
                  />
                </Stack>
              </Stack>
              ...
              {deadlinesLoading || eventsLoading ? (
                ...
                <Box>
                  ...
                  >
                    {weekDays.map((day) => (
                      <Typography key={day} variant="caption" color="text.secondary" sx={{ px: 1, fontWeight: 700 }}>
                        {day}
                      </Typography>
                    ))}
                  </Box>
                    ...
                    {monthGrid.map((cell) => {
                      ...
                      return (
                        <Button
                          key={cell.key}
                          variant="text"
                          onClick={() => setSelectedDateKey((prev) => (prev === cell.key ? '' : cell.key))}
                          sx={{
                            minHeight: 82,
                            px: 1,
                            py: 1,
                            ...
                            boxShadow: isSelected ? '0 10px 22px rgba(79,70,229,0.24)' : 'none',
                            opacity: cell.inCurrentMonth ? 1 : 0.42,
                            '&:hover': {
                              borderColor: 'primary.main',
                              bgcolor: isSelected ? 'primary.dark' : 'rgba(99,102,241,0.12)',
                            },
                          }}
                        >
                            ...
                            {cell.eventCount > 0 ? (
                              <Box
                                sx={{
                                  ...
                                  height: 8,
                                  borderRadius: '50%',
                                  bgcolor: cell.hasImportantEvent
                                    ? isSelected
                                      ? 'warning.light'
                                      : 'error.main'
                                    : isSelected
                            ...
                            {cell.deadlineCount > 0 ? (
                              <Typography
                                ...
                                sx={{
                                  ...
                                  borderRadius: 999,
                                  fontWeight: 700,
                                  bgcolor: isSelected ? 'rgba(255,255,255,0.2)' : 'rgba(99,102,241,0.10)',
                                  color: isSelected ? 'inherit' : 'primary.main',
                                }}
                              >
                                {cell.deadlineCount} due
                              </Typography>
                            ) : null}
                          </Stack>
                        </Button>
