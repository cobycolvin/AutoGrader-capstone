...
import { AssignmentRounded, OpenInNewRounded, EventRounded } from '@mui/icons-material'
import { Link as RouterLink, useParams } from 'react-router-dom'
import { apiRequest } from '../api/client.js'

const submissionOutcomeLabel = (statusRaw) => {
...
function CourseOverviewStudent() {
  ...
  const nextAssignmentLink = upcoming[0]
    ? `/course/${courseId}/assignments/${upcoming[0].id}`
                ...
                recentSubmissions.map((submission) => (
                  ...
                  >
                    ...
                    <Stack direction="row" spacing={1} sx={{ mt: 1 }}>
                      <Chip label={submissionOutcomeLabel(submission.status)} size="small" variant="outlined" />
                      <Chip
                        label={
