...
function App({ mode, onToggleMode }) {
  ...
  return (
    ...
    >
      <Routes>
        <Route path="/" element={<Dashboard busy={busy} user={user} />} />
        ...
        <Route path="/catalog" element={<CourseCatalogPage user={user} />} />
        <Route
          path="/admin/users"
        ...
        />
        <Route path="/assignments" element={<Navigate to="/my-courses" replace />} />
        <Route path="/submissions" element={<Navigate to="/my-courses" replace />} />
        <Route path="/integrity" element={<Navigate to="/" replace />} />
