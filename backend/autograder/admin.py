...
from .models import CalendarEvent, Course, Enrollment, PendingEnrollment, ProgrammingLanguage
...
class PendingEnrollmentAdmin(admin.ModelAdmin):
    list_display = ('course', 'display_name', 'cwid', 'sis_login_id', 'status', 'claimed_by_user')
