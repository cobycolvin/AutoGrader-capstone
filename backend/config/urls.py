...
from autograder.api.rubric_templates import RubricTemplateViewSet
...
router.register('rubric-templates', RubricTemplateViewSet, basename='rubric-template')
...
urlpatterns = [
    ...
    path('api/change-password/', account_views.api_change_password),
    path('api/forgot-password/', account_views.api_forgot_password),
    path('api/reset-password/', account_views.api_reset_password),
